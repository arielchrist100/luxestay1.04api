      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-muted-foreground text-lg">
            Rejoignez LuxeStay et profitez de nos offres exclusives
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="bg-card border border-border rounded-3xl p-8 space-y-6">
          ...
          {/* Terms */}
          <div className="flex items-start gap-3 p-4 bg-input-background rounded-xl">
            <input
              type="checkbox"
              id="terms"
              required
        ...
        <div className="space-y-3">
          <button
            ...
            disabled={isLoading}
            className="w-full px-6 py-3 bg-card border border-border rounded-xl hover:bg-input-background transition-colors flex items-center justify-center gap-3 disabled:opacity-50"
          >
